...
def build_config_settings():
    ...
    settings.update({
        ...
        "margin_v": {"category": "caption", "label": "세로 여백 (default 스타일 전용)", "job_key": "caption_margin_v", "env": "CAPTION_MARGIN_V", "default": default_caption_margin_v, "kind": "positive_int"},
        "margin_h": {"category": "caption", "label": "가로 여백 (default 스타일 전용)", "job_key": "caption_margin_h", "env": "CAPTION_MARGIN_H", "default": default_caption_margin_h, "kind": "positive_int"},
