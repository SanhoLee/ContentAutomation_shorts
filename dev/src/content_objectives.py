...
OBJECTIVE_PROFILES: dict[str, dict[str, float]] = {
    "subscriber_growth": {
        "net_subscriber_conversion": 0.25,
        "subscriber_conversion": 0.10,
        "average_view_percentage": 0.15,
        "initial_engagement": 0.10,
        "share_rate": 0.10,
        "comment_rate": 0.05,
        "topic_family_conversion": 0.10,
        "series_potential": 0.10,
        "channel_fit": 0.05,
    },
    "reach": {
        "views_percentile": 0.20,
        "initial_engagement": 0.25,
        "average_view_percentage": 0.15,
        "trend_signal": 0.20,
        "share_rate": 0.10,
        "novelty": 0.10,
    ...
    "retention": {
        "average_view_percentage": 0.35,
        "initial_engagement": 0.20,
        "replay_lift": 0.15,
        "duration_matched_retention": 0.15,
        "narrative_fit": 0.10,
        "trend_signal": 0.05,
    },
    "share_growth": {
