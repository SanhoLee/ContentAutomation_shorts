...
-t "$DURATION" \
-filter_complex "[0:v]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,subtitles=${WORK_DIR}/subs.srt:force_style='FontName=Noto Sans CJK KR,FontSize=22,PrimaryColour=&H00FFFFFF,Outline=2,BorderStyle=3,MarginV=200'[v]; \
[2:a]volume=0.15[bgm]; \
